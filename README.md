...
## Project Structure
* **[Automation](./automation)**: End-to-end tests using Playwright and JavaScript with Telegram Bot API, Jira API integration.
* **[Manual](./manual)**: Test documentation, including Test Plans, Bug Reports, SQL scripts, and Postman collections.
